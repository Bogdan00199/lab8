...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 24 2021 г., 19:53
...
--
-- Ограничения внешнего ключа таблицы `account_pokypcy`
--
ALTER TABLE `account_pokypcy`
  ADD CONSTRAINT `account_pokypcy_ibfk_1` FOREIGN KEY (`id_pokypcy`) REFERENCES `account_pokypcy` (`id_pokypcy`);
